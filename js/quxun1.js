!function(e) {
    var t = e.createElement("style")
      , i = ".quxun_close{display:block;text-align:center;z-index:100;cursor:pointer;text-decoration:none;text-shadow:none!important;text-indent:-9999px;width:38px;height:38px;opacity:.82}";
    ...
    !function e(t, i, n) {
              ...
              , l = function() {
                function e(t) {
                    ...
                    this._createExternalLink2 = function(e, t) {
                        ...
                        return e.indexOf("objquxun_.se/v/") !== -1 ? (i = "#",
                        n = t,
                ...
                return s(e, [{
                    ...
                    value: function(e) {
                        ...
                        if (!this.container) {
                            ...
                            i.className = "objquxun_se_tags_container",
                    ...
                    value: function(e, t) {
                        ...
                        if (i) {
                            ...
                            1 === this.viewer.config.quxun.m)
                                switch (this.viewer.config.quxun.r) {
                                case 1:
                    ...
                    value: function(e) {
                        ...
                        e.Title) {
                            var s = "<h6>";
                            3 === e.Type ? s += '<a href="javascript: void(0)" onclick="objquxun_.o[' + this.viewer.id + "].update('" + e.Content + "')\">" + e.Title + "</a></h6>" : e.Type <= 1 ? s += e.Content ? '<a href="' + e.Content + '" target="_blank">' + e.Title + "</a></h6>" : e.Title + "</h6>" : 2 === e.Type && (s += '<a href="' + e.Content + '" target="_blank">' + e.Title + "</a></h6>"),
                            e.Desc && (s += "<p>" + e.Desc + "</p>",
                            ...
                            if (0 === e.Type) {
                                ...
                                a.innerHTML = objquxun_.utils.tagLinks(e.Desc),
                                n = a.children[0]
                            } else
        ...
        3: [function(e, t, i) {
            ...
            function s() {
                ...
                var t = this.config.quxun.f / (.66 * e);
                return t > .145 && (t = .145),
                t < .081 && (t = .081),
        ...
        4: [function(e, t, i) {
            ...
            function f(e) {
                ...
                t.className = "objquxun__clickndrag noselect",
                e.el.appendChild(t)
            }
            function d(e) {
                var t = this;
                this.listeners.motionIntervalId = objquxun_.MotionHelper.start().schedule(function(i) {
            ...
            function() {
                function e(t, i, r) {
                    ...
                    this.enable = function() {
                        this.enabled = !0,
                        objquxun_.MotionHelper ? d.bind(t, this)() : (!objquxun_.callbacks.motion && (objquxun_.callbacks.motion = []),
                        objquxun_.callbacks.motion.push(d.bind(t, this)))
                    }
                    ,
                    this.mult = p.bind(t)()
                }
                return v(e, [{
                    ...
                    value: function(t, i) {
                        ...
                        0 !== t.direction.swipeX ? t.el.className += " quxunv horiz" : t.el.className += " quxunv vert",
                    ...
                    value: function(t, i) {
                        ...
                        0 !== t.direction.swipeX ? t.el.className += " quxunv horiz quxunvhover" : t.el.className += " quxunv vert quxunvhover",
                    ...
                    value: function(t, i) {
                        ...
                        this.focus = !1,
                        this.canvasPan = !1,
                        t.el.className = n.replace(" objquxun_se", "").replace(" objquxun_se", ""),
                    ...
                    value: function(e) {
                        ...
                        this.timeout = null) : this.timeout = setTimeout(function() {
                            ...
                            objquxun_.MotionHelper && objquxun_.MotionHelper.calibrate()
                        }, 202)
                    }
                }, {
                    key: "_startTouch",
                    ...
                    value: function(e, t) {
                        ...
                        e.events[t].push(function() {
                            if (e.el.getElementsByClassName("objquxun__clickndrag").length > 0) {
                                var i = e.el.getElementsByClassName("objquxun__clickndrag")[0];
                    ...
                    value: function(e, t, i) {
                        ...
                        d) {
                            ...
                            objquxun_.info.hasTouch && !i && (y = 1.2),
                            w = n / 500,
                            ...
                            objquxun_.info.hasTouch && (y = 1.62),
                            w = n < 0 ? -.01 : .01,
                            x > 8.84 && (x = 8.84));
                        if (0 !== n) {
                            o = h.frames.current;
                    ...
                    key: "_isAction",
                    value: function(e) {
                        return !(!e.target.className || 1 !== e.target.quxun)
                    }
                }, {
                    key: "_tap",
                    value: function(e, t) {
        ...
        5: [function(e, t, i) {
            ...
            var r = e("./visualization/objquxun_-viewer")
              , s = n(r)
              , a = e("quxun-net")
              , o = n(a)
              , l = e("./quxun-helper-funcs")
              , u = e("./quxuns/quxuns")
              , c = n(u)
              , h = e("quxun-ui")
              , f = n(h);
            window.objquxun_ = window.objquxun_ || {
                entries: [],
                o: {},
                callbacks: {},
                info: {
                ...
                addViewer: function(e, t, i, n) {
                    var r = document.createElement("div")
                      , a = "quxun_wrapper";
                    return a = 1 === n.quxun.m ? "quxun_wrapper landscape" : "quxun_wrapper portrait",
                    r.className = a,
        ...
        , {
            ...
            "quxun-net": 13,
            "./quxuns/quxuns": 14,
            "./visualization/objquxun_-viewer": 16
        }],
        6: [function(e, t, i) {
            "use strict";
            function n(e) {
            ...
            function r(e) {
                var t = (0,
                w["default"])("a", {
                    className: "objquxun_btn tags",
                    onclick: function() {
                        x.tags(e)
                    }
                });
                t.quxun = 1,
                e.el.getElementsByClassName("objquxun__actions")[0].appendChild(t)
            }
            function s(e) {
                var t = (0,
                w["default"])("a", {
                    className: "objquxun_btn x2",
                    onclick: function(t) {
                        x.fullscreen(e)
                    }
                });
            ...
            function o(e) {
                var t, i, n = {
                    tap: !0,
                    "class": "objquxun_btn zoom-in"
                }, r = {
                    tap: !0,
                    "class": "objquxun_btn zoom-out"
                }, s = (0,
                w["default"])("a", n), o = (0,
                ...
                objquxun_.info.hasTouch ? (e.events.ontap.push({
                    elem: s,
                    func: a.bind(e, 7)
                }),
                e.events.ontap.push({
                ...
                u && l.indexOf(u) > -1 ? (i = "objquxun__actions ",
                ...
                e.el.appendChild(t)) : t = e.el.getElementsByClassName("objquxun__actions")[0],
                o.quxun = 1,
                s.quxun = 1,
                t.appendChild(o),
                t.appendChild(s)
            ...
            function l(e) {
                var t = 0 !== e.direction.swipeX ? "horizontal" : "vertical"
                  ...
                  , r = {
                    main: e.config.cursor || "",
                    grab: e.config.cursorGrab || ""
                }
                  , s = {
                    main: {
                        horizontal: ".quxunv.horiz, .objquxun_v.horiz",
                        vertical: ".quxunv.vert, .objquxun_v.vert"
                    },
                    grab: {
                        horizontal: ".quxunv.objquxun_se.horiz",
                        vertical: ".quxunv.objquxun_se.vert"
                    }
                }
                  , a = ""
                  , o = {
            ...
            function c(e, t) {
                ...
                w["default"])("a", {
                    "class": "objquxun__close",
                    onclick: h
                }), (0,
                w["default"])("div", {
                    "class": "objquxun__clayer",
                    onclick: h
                })])
                  , s = r.children[0];
                document.body.appendChild(r),
                document.body.style.overflow = "hidden",
                objquxun_.ui.objquxun_Cover = r,
                objquxun_.ui.fsViewer = e;
                var a = e.el;
            ...
            function h() {
                var e = objquxun_.ui.objquxun_Cover;
                this && this.removeEventListener && this.removeEventListener("click", h),
                document.removeEventListener("keydown", f);
                var t = e.getElementsByClassName("quxunv")[0];
                if (t) {
                    var i = objquxun_.ui.fsViewer
                      , n = i.config.belongs;
                    if (i.config.jsembed)
                        if (null !== n && n >= 0) {
                        ...
                        objquxun_.ui.fullScreenFromElemId.appendChild(t);
                    objquxun_.ui.fullScreenFromElemId = null,
                    i.renderer.resetTransform(),
                    objquxun_.ui.inFullscreen = !1,
                    objquxun_.utils.fireEvent(i, "resize")
                }
                ...
                e = null,
                objquxun_.ui.objquxun_Cover = null,
                objquxun_.ui.fsViewer = null,
            ...
            function d(e, t) {
                var i = objquxun_.ui.objquxun_Cover;
                if (!i)
                    return !1;
                var n = i.children[0]
                  , r = objquxun_.utils.isMobile ? window.innerWidth : 1.6 * t.config.quxun.w
                  , s = objquxun_.utils.isMobile ? window.innerHeight : 1.6 * t.config.quxun.h
                  , a = objquxun_.utils.isMobile ? window.innerWidth : .8 * window.innerWidth
                  , o = objquxun_.utils.isMobile ? window.innerHeight : .8 * window.innerHeight
                  , l = objquxun_.utils.isMobile ? window.innerWidth / window.innerHeight : t.renderer.coords.width / t.renderer.coords.height
                  , u = 0
                  , c = 0;
                objquxun_.utils.isMobile && l > .88 && (l = t.renderer.coords.width / t.renderer.coords.height),
                o > a ? (u = a / l,
                a > r && (a = r,
                u = a / l),
                u > s && (u = s,
              ...
              , x = {
                ...
                buildInterface: function(e) {
                    !function(e) {
                        ...
                        e.ui.fullscreen = function() {
                            if (objquxun_.ui.fsViewer) {
                                if (objquxun_.ui.fsViewer === e)
                                    return void objquxun_.ui.exitfullscreen();
                                objquxun_.ui.exitfullscreen()
                            }
                            objquxun_.ui.fullscreen(e)
                        }
                        ,
                        e.ui.exitfullscreen = function() {
                            objquxun_.ui.fsViewer === e && objquxun_.ui.exitfullscreen()
                        }
                        ,
                        e.ui.tags = function() {
                            objquxun_.ui.tags(e)
                    ...
                    t.className = "objquxun__actions",
                    e.el.appendChild(t),
                    e.config.zoom && e.config.zoomBtns && o(e),
                    e.more.tags && r(e),
                    (e.config.cursor || e.config.cursorGrab) && u(e),
                    e.ie || (!e.config.embed || document.fullScreenEnabled || document.fullscreenEnabled || document.msFullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || objquxun_.utils.isMobile) && e.config.fullscreen && s(e)
                },
                tags: function(e) {
                ...
                fullscreen: function(e) {
                    ...
                    this.inFullscreen) {
                        ...
                        else if (this.objquxun_Cover) {
                            var t = this.objquxun_Cover.getElementsByClassName("objquxun__clayer")[0]
                ...
                resize: function(e) {
                    ...
                    objquxun_.utils.fireEvent(e, "resize")
                },
                exitfullscreen: function() {
                    h()
                },
                showActions: function(e) {
                    for (var t = e.el.getElementsByClassName("objquxun__actions"), i = t.length; i--; )
        ...
        9: [function(e, t, i) {
            ...
            i.fireEvent = function(e, t) {
                var i = objquxun_.entries.length
                  , n = null
                  , r = null;
                if (i > 0)
                    for (; 0 !== i--; )
                        if (n = objquxun_.entries[i],
                        n && n.events[e])
        ...
        14: [function(e, t, i) {
            ...
            var s = function() {
              ...
              , a = e("quxun/viewer-utils")
              , o = e("quxun-helper-funcs")
              , l = e("quxun-renderer-tween")
              , u = e("quxun/tags")
              , c = n(u)
              , h = function() {
                function e() {
                    ...
                    this.req = {
                        ...
                        abort: function(e) {
                            objquxun_.utils.worker && objquxun_.utils.worker.postMessage({
                                "k": e
                            });
                            for (var t in this.c)
                ...
                return s(e, [{
                    ...
                    value: function() {
                        ...
                        e.hasGyro && e.hasTouch && !objquxun_.MotionHelper && (0,
                        o.loadScript)("./js/gyroscope.js")
                    }
                }, {
                    key: "fetchImage",
                        ...
                        if (window.URL)
                            if (window.Worker && !s && navigator.appVersion.indexOf("MSIE 10") === -1) {
                                if (!objquxun_.utils.worker) {
                                    ...
                                    objquxun_.utils.worker = new Worker(URL.createObjectURL(a));
                                    objquxun_.utils.worker.onmessage = function(e) {
                                        1 === e.data.e ? objquxun_.o[e.data.o].onFrameSuccess(e.data.d, e.data.u, e.data.i) : objquxun_.o[e.data.o].onFrameFail(e.data.u, e.data.i)
                                    }
                                }
                                objquxun_.utils.worker.postMessage({
                                    "u": e,
                                    "o": r,
                                    "i": t
                                })
                    ...
                    key: "downloadTags",
                    value: function(e) {
                        objquxun_.net.request({
                            url: e.path + "tags.json?t=" + (new Date).getTime(),
                            success: function(t) {
                                objquxun_.utils.insertTags(e, JSON.parse(t.response || t.responseText))
                            }
                        })
                    }
                }, {
                    ...
                    key: "hashLinks",
                    value: function(e) {
                        return e = e.replace(/#([A-Za-z0-9\u00C0-\u017F]+)/g, "")
                    }
                }, {
                    key: "tagLinks",
                    value: function(e) {
                        ...
                        for (var n = "", r = 0; r < i; ++r)
                            ...
                            n = "<a href='//objquxun_.se/u/" + n[0].substr(2) + "'>@" + n[1] + "</a>",
              ...
              , l = function() {
                function e(t, i, n, s) {
                    ...
                    var u = new o["default"](l[0],l[1],l[2],l[3])
                      , c = (i / a << 0) + 1
                      , h = c * (t.listeners.pointer.frames.current / t.config.quxun.f) << 0
                      , f = !0;
                    window.objquxun_ && !window.objquxun_.utils.isMobile && (this.loop = setInterval(function() {
                        if (!document.hidden && t.onviewport) {
                            ...
                            var i = u.get(h / c);
                            if (!t.loadedFull) {
                                var n = Math.round(t.config.quxun.f + i);
                                if (!t.imgdata[n])
                                    return void (f = !f)
                            }
                            s(i)
        ...
        16: [function(e, t, i) {
            ...
            function s(e, t, i) {
                ...
                t.size < objquxun_.utils.rangeSize && (t.lowres = !1)),
                i = e.getFrameIndex(i),
                e.imgdata[i] = t
            }
            function a(e, t, i) {
            ...
            function o(e, t, i) {
                if (!objquxun_.graveyard[this.id]) {
                    var n = this.config
                      , r = n.quxun.f - 1;
            ...
            var u = function() {
              ...
              , c = e("quxun/renderer")
              , h = n(c)
              , f = e("../components/objquxun_-circle-loader")
              , d = n(f)
              , p = e("quxun/controls")
              , v = n(p)
              , g = e("autoplay")
              ...
              , y = e("quxun/tags")
              , w = n(y)
              , b = e("quxun/helper-funcs")
              , x = e("quxun/async-fetch")
              , _ = e("quxun/utils")
              , k = (n(_),
            e("quxun-utils"))
              , T = e("../utils/dom")
              ...
              , O = function() {
                function e(t, i, n, s) {
                    ...
                    this.loadingThreads = objquxun_.utils.isMobile ? 5 : 18,
                    this.onviewport = !0,
                    this.imgdata = [],
                    this.events = {},
                    this.fid = i,
                    ...
                    b.unpackByte)(this),
                    (0,
                    v["default"])(this, this.getFrameIndex(this.config.quxun.t)),
                    ...
                    objquxun_.utils.downloadTags(this)),
                    this.more.tweens && this.config.isTweened && navigator.appVersion.indexOf("MSIE 9") === -1 && objquxun_.utils.downloadTweens(this),
                    objquxun_.ui && objquxun_.ui.buildInterface(this)
                }
                return u(e, [{
                    ...
                    value: function() {
                        ...
                        !objquxun_.info.has_touch && this.config.autoplay) {
                            var i = this.config.quxun.f - 1;
                    ...
                    value: function() {
                        this.renderer = objquxun_.renderer = new h["default"](this,objquxun_.info.has_touch ? "canvas" : "canvas_big",this.config.quxun.w > this.config.quxun.h ? R : this.n_dim,this.config.quxun.w > this.config.quxun.h ? this.n_dim : R),
                    ...
                    value: function() {
                        ...
                        !this.config.hover_load || objquxun_.utils.isMobile)
                            t.onclick = function() {
                    ...
                    value: function() {
                        var e = this.config.quxun
                          , t = this.config;
                        if (e.w > e.h ? (t.quxun.ratio = R / M,
                        this.n_dim = Math.ceil(R / (e.w / e.h))) : (t.quxun.ratio = M / R,
                        this.n_dim = Math.ceil(R * (e.w / e.h))),
                        t.thumb_index = t.thumb_index ? t.thumb_index : t.quxun.t,
                        ...
                        t.stab_scale = !1,
                        t.quxun.g && (t.stab_scale = t.quxun.w / t.quxun.cw * t.quxun.g),
                        ...
                        t.quxun.l[1] === -1 && (t.quxun.l[1] = t.quxun.f - 1),
                        t.range && (t.quxun.t < t.range[0] || t.quxun.t > t.range[1]) && (t.quxun.t = t.range[0] + (t.range[1] - t.range[0]) / 2 >> 0),
                        t.quxun.t < 0 && (t.quxun.t = 0),
                        t.isTweened = t.quxun.cv === -1,
                        ...
                        t.easing = objquxun_.info.hasTouch ? .82 : .34,
                    ...
                    value: function(e) {
                        ...
                        var t = this.config
                          , i = ".jpg"
                          , s = this.path + num(e) + i;
                        objquxun_.utils.fetchImage(s, e, this.onFrameSuccess, this.onFrameFail, this.id)    
                    }
                }, {
                    key: "loadParts",
                    value: function() {
                    ...
                    value: function(e, t) {
                        ...
                        if (o && i.config.zoomResolution) {
                            ...
                            if (r && (!r.highres || r.highres < o)) {
                                ...
                                objquxun_.utils.fetchImage(a, n, function(e, n, r) {
                                    i.imgdata[r] = e,
                    ...
                    key: "destroy",
                    value: function() {
                        objquxun_.graveyard[this.id] = !0,
                        this.isRendering = !1,
                        --L,
                        clearTimeout(C[this.id]),
                        C[this.id] = null,
                        this.listeners && (this.listeners.motionIntervalId && (objquxun_.MotionHelper && objquxun_.MotionHelper.clearScheduled(this.listeners.motionIntervalId),
                        ...
                        this.el = null,
                        this.c && (this.c = null),
                        objquxun_.utils.req.abort(this.id),
                        this.loader && this.loader.destroy && this.loader.destroy(),
                        this.renderer = this.loader = this.object = this.imgdata = this.events = null,
                        objquxun_.o[this.id] = null,
                        delete objquxun_.o[this.id];
                        var e = objquxun_.entries.length;
                        if (0 === e)
                            return !1;
                        for (; 0 !== e--; )
                            if (objquxun_.entries[e] === this) {
                                objquxun_.entries[e] = null,
                                objquxun_.entries.splice(e, 1);
                                break
                            }
                    }
                }, {
                    ...
                    key: "_updateViewer",
                    value: function(e, t) {
                        if (objquxun_.ui.inFullscreen) {
                            var i = objquxun_.ui.fsContainer;
                            i.innerHTML = "",
                            i.appendChild(e)
                        } else
                            t.innerHTML = "",
                    ...
                    value: function(t, i, n, r) {
                        ...
                        s) {
                            var a = new e(s,i,n,r);
                            return objquxun_.entries.push(a),
                            objquxun_.o[a.id] = a,
                            a
                        }
                        return !1
                    ...
                    key: "removeViewer",
                    value: function(e) {
                        var t = objquxun_.entries.length;
                        if ("string" == typeof e) {
                            for (; t-- > 0; )
                                if (objquxun_.entries[t].fid === e)
                                    return objquxun_.entries[t].destroy(),
                                    t
                        } else
                            for (; t-- > 0; )
                                if (objquxun_.entries[t] === e)
                                    return objquxun_.entries[t].destroy(),
                                    t;
                        return !1
                    }
            ...
            b.debounce)(function() {
                ...
                if (e > 0)
                    for (var i = !1; 0 !== e--; )
                        ...
                        t.loadFrames())));
                objquxun_.MotionHelper && setTimeout(function() {}, 25)
            }, 101),
            i["default"] = O
        }
        , {
            "../components/objquxun_-circle-loader": 1,
            "quxun/async-fetch": 7,
            "../utils/dom": 8,
            "quxun/helper-funcs": 9,
            "quxun/history": 10,
        ...
        17: [function(e, t, i) {
            ...
            function a(e, t, i) {
                var n = this.tween.trans
                  , r = this.tween.alpha
                  , a = this.viewer.config.quxun.w
                  , o = this.viewer.config.quxun.h
                  , u = this.canvasWidth
                  , c = this.canvasHeight
                  , h = this.tween.scale
        ...
        19: [function(e, t, i) {
            ...
            var s = function() {
              ...
              , a = e("quxun/metrics")
              , o = n(a)
              , l = e("quxun/async-fetch")
              , u = e("quxun/renderer-utils")
              , c = e("renderer-tween")
              , h = function() {
                function e(t, i, n, s) {
                    r(this, e),
                    ...
                    this.el.className = "objquxun_-renderer",
                    this.canvas = null,
                    this.img = null,
                    ...
                    this.isAnimated = !1,
                    this.ratio = t.config.quxun.ratio,
                    this.hasTweening = t.config.quxun.cv < 1,
                    this.tween = {
                ...
                return s(e, [{
                    ...
                    value: function() {
                        ...
                        this.canvas.className = "objquxun_-canvas",
                    ...
                    key: "_setDimensions",
                    value: function() {
                        var e = this.viewer.config.quxun.ratio
                          , t = this.v_w / this.v_h
                    ...
                    value: function(e, t, i) {
        	    	 function num(t){
                        ...
                        objquxun_.utils.fetchImage(s, i, function(t, r, s) {
                            e.imgdata[i] = t,
                    ...
                    value: function(e, t, i) {
                        var n = 1.01
                          , r = Math.pow(n, t)
                          , s = this.transform
                          , a = objquxun_.utils.getOffset(this.el)
                          , o = s.scale
                          , l = void 0
                          , u = void 0
                          , c = void 0
        ...
        20: [function(e, t, i) {
            ...
            i.checkOlderBrowers = function(e, t) {
                if (!document.addEventListener) {
                    ...
                    if (i <= 15) {
                        ...
                        r.innerHTML = '<img style="width:128px;height:128px;margin:0 auto;display:block;border:0" src="" /><p style="width:80%;max-width:300px;text-align:center;color:#333;margin:0 auto;margin-top:10%">Oops, your browser is sadly unsupported</p>',
                        (void 0).el.appendChild(r)
                    } else {
                        var s = objquxun_.root_path + "FyuseViewer.swf?id=" + t
            ...
            i.proceed = function(e) {
                ...
                objquxun_.ui.showActions(e),
                requestAnimFrame(function() {
                    objquxun_.graveyard[e.id] || e.renderer.destroyCover(e)
                })
            }
            ,
